...
class RSLRecognitionApp(QMainWindow):
    ...
    def _process_collected_sentence(self):
        ...
        prompt_lines = [
            ...
            "Финальное предложение должно быть на русском языке и написано без грамматических ошибок, то есть звучать как настоящее предложение (или просто набор слов, если сказано чтото несвязное).",
